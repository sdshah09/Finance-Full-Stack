"""
Django settings for financial_data_1 project.
...
SECRET_KEY = 'django-insecure-$vpyxi-s^928p_1rgc-%yp!yp7t(ff2@k6yljgue+b!##jmpy&'
...
#         'NAME': 'financial_db',   # Replace with your DB name
